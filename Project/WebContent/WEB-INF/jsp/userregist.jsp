					...
					<div class="card-body">
						<form action="UserResistConfirm">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="customerName" placeholder="顧客名" required>
							</div>
							<div class="form-group">
								<label for="inputNamekana4">顧客名かな</label>
								<input type="text" class="form-control" name="customerNamekana" placeholder="顧客名かな" required>
							</div>
							<div class="form-group">
								<label for="inputPostalCode">郵便番号</label>
								<input type="text" class="form-control" name="postalCode" placeholder="郵便番号" required>
							</div>
							<div class="form-group">
